...
export class GoogleAuth {
  ...
  public setAccessToken(access_token: string) {
    window.localStorage.setItem(LocalStorageKeys.ACCESS_TOKEN, access_token);
    return access_token;
  }
  ...
  public setRefreshToken(refresh_token: string) {
    window.localStorage.setItem(LocalStorageKeys.REFRESH_TOKEN, refresh_token);
  ...
  public getExpiresAt(): number | null {
    const expiresAt = window.localStorage.getItem(LocalStorageKeys.EXPIRES_AT);
